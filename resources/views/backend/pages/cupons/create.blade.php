            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card card-dark">
                        <form action="{{ route('cupons.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header clearfix">
                                <h3 class="card-title float-left">Add New Copon</h3>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="label"for="name">Cupon Name <small class="text-muted">(Must Provide & Unique)</small></label>
                                    <input type="text" id="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="Cupon Name" name="name" autofocus>
                                    @if ($errors->has('name'))
                                 ...
                                 <div class="form-group">  
                                    ...
                                    <input type="text" id="cupon_code" class="form-control{{ $errors->has('cupon_code') ? ' is-invalid' : '' }}" value="{{ old('cupon_code') }}" placeholder="Cupon Code" name="cupon_code">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="value" class="form-control{{ $errors->has('value') ? ' is-invalid' : '' }}" value="{{ old('value') }}" placeholder="Cupon Value" name="value" autofocus>
                                    @if ($errors->has('value'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="card-footer clearfix">
                                <div class="form-group float-right">
                                    <button class="btn btn-md btn-dark btn-flat">Add New Cupon</button>
                                </div>
                            </div>
                        </form>
                    </div>
