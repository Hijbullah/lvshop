                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover theme-color c_table">
                                ...
                                <tbody>
                                <tr>
                                    <td class="w70"><img class="w50" src="{{ asset('backend/images/ecommerce/1.png') }}" alt=""></td>
                                    <td><a href="javascript:void(0)" class="text-muted">PlayStation 4 1TB (Jet Black)</a></td>
                                    <td>3,432</td>
                                </tr>
                                <tr>
                                    <td><img class="w50" src="{{ asset('backend/images/ecommerce/2.png') }}" alt=""></td>
                                    <td><a href="javascript:void(0)" class="text-muted">Printed color block T-shirt</a></td>
                                    <td>852</td>
                                </tr>
                                <tr>
                                    <td><img class="w50" src="{{ asset('backend/images/ecommerce/3.png') }}" alt=""></td>
                                    <td><a href="javascript:void(0)" class="text-muted">Wireless headphones</a></td>
                                    <td>1,321</td>
                                </tr>
                                <tr>
                                    <td><img class="w50" src="{{ asset('backend/images/ecommerce/4.png') }}" alt=""></td>
                                    <td><a href="javascript:void(0)" class="text-muted">PlayStation 4 1TB (Jet Black)</a></td>
                                    <td>980</td>
                                </tr>
                                <tr>
                                    <td><img class="w50" src="{{ asset('backend/images/ecommerce/5.png') }}" alt=""></td>
            ...
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body">
                            <ul class="row list-unstyled c_review">
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{ asset('backend/images/sm/avatar2.jpg') }}" alt="user" width="60"></a>
                                    </div>
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{ asset('backend/images/sm/avatar3.jpg') }}" alt="user" width="60"></a>
                                    </div>
                                    <div class="comment-action">
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{ asset('backend/images/sm/avatar4.jpg') }}" alt="user" width="60"></a>
                                    </div>
                                    <div class="comment-action">
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{ asset('backend/images/sm/avatar5.jpg') }}" alt="user" width="60"></a>
                                    </div>
                                    <div class="comment-action">
                ...
                <div class="col-xl-4 col-lg-5 col-md-12">
                    <div class="card mcard_1">
                        <div class="img">
                            <img src="{{ asset('backend/images/image-gallery/2.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="body">
                            <div class="user">
                                <img src="{{ asset('backend/images/sm/avatar1.jpg') }}" class="rounded-circle img-raised" alt="profile-image">
...
@push('page-css')
    <link rel="stylesheet" href="{{ asset('backend/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}"/>
    <link rel="stylesheet" href="{{ asset('backend/plugins/morrisjs/morris.css') }}" />
@endpush



@push('page-scripts')
    <script src="{{ asset('backend/bundles/morrisscripts.bundle.js') }} "></script> <!-- Morris Plugin Js -->
    ...
    <script src="{{ asset('backend/bundles/knob.bundle.js') }} "></script> <!-- Jquery Knob Plugin Js -->

    <script src="{{ asset('backend/js/pages/ecommerce.js') }} "></script>
    <script src="{{ asset('backend/js/pages/charts/jquery-knob.min.js') }} "></script>
@endpush
