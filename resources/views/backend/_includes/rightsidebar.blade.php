...
<div class="navbar-right">
    <ul class="navbar-nav">
                        ...
                        <li>
                            <div class="progress-container progress-primary">
                                ...
                                <ul class="list-unstyled team-info">
                                    ...
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar2.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar3.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar4.jpg') }}" alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar10.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar9.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar8.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar7.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar6.jpg') }}" alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container progress-warning">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar5.jpg') }}" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('backend/images/xs/avatar2.jpg') }}" alt="Avatar">
                                    </li>
        ...
        <li>
            <a href="{{ route('admin.logout') }}" class="mega-menu" title="Sign Out"
